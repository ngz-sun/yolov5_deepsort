...
class DeepSort(object):
    ...
    def update(self, bbox_xywh, cls, confidences, ori_img):
        ...
        detections = [Detection(bbox_tlwh[i], cls[i], conf, features[i]) for i, conf in enumerate(confidences) if
        ...
        # cls = np.array([d.cls_ for d in detections])
        # print("看看怎么变化的", cls)
        ...
        for track in self.tracker.tracks:
            ...
            # print("hhhhhhhh",track.cls_)
            outputs.append(np.array([x1, y1, x2, y2,track_id,track.cls_], dtype=np.int))
